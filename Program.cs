...
namespace gesdette
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            IClientRepository clientRepository = (ClientRepositoryListe)clientRepoFactory.createRepository();
            IUserRepository userRepository = (UserRepositoryListe)userRepoFactory.createRepository();
