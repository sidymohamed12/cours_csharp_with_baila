...
namespace gesdette.repository.list
{
    public class ArticleRepositoryList : RepositoryListeImplement<Article>, IArticleRepository
    {
        ...
        {
            if (dette.Details == null) return new List<Article>();
        ...
        {
            return listes.FirstOrDefault(art => art.Reference.Equals(name, StringComparison.Ordinal));
        }
        ...
        {
            var existingArticle = listes.FirstOrDefault(art => art.Reference.Equals(article.Reference));
