...
namespace gesdette.repository.list
{
    ...
    public class UserRepositoryListe : RepositoryListeImplement<User>, IUserRepository
    {
        ...
        {
            return listes.FirstOrDefault(user => user.Login.Equals(name, StringComparison.Ordinal));
        }
        ...
        {
            var existingUser = listes.FirstOrDefault(value => value.Login.Equals(user.Login, StringComparison.Ordinal));
